import type { Product, Listing, Grade } from "./types";
...
export const products: Product[] = [
  ...
  // ── Accessories & Essentials (extended) ──
  {
    id: "belkin-boostcharge-30w",
    name: "Belkin BoostCharge 30W USB-C GaN Wall Charger",
    brand: "Belkin",
    category: "Accessories",
    subcategory: "Chargers & Cables",
    image: phone,
    retail: 4500,
    specs: [
      { label: "Power", value: "30W GaN" },
      { label: "Port", value: "USB-C PD 3.0" },
      { label: "Compatibility", value: "iPhone, Galaxy, iPad" },
    ],
  },
  {
    id: "baseus-cable-organizer",
    name: "Baseus Travel Cable Organizer Pouch",
    brand: "Baseus",
    category: "Essentials",
    image: phone,
    retail: 850,
    specs: [
      { label: "Capacity", value: "Cables, chargers, earbuds" },
      { label: "Material", value: "Water-repellent fabric" },
      { label: "Layout", value: "3 elastic loops + zip pocket" },
    ],
  },
  {
    id: "samsung-galaxy-buds2",
    name: "Samsung Galaxy Buds2 Wireless Earbuds (ANC)",
    brand: "Samsung",
    category: "Essentials",
    subcategory: "Earbuds",
    image: headphones,
    ...
    specs: [
      ...
      { label: "Battery", value: "Up to 29h with case" },
      { label: "Rating", value: "IPX2 sweat resistant" },
    ],
  },
  {
    id: "jbl-flip-6",
    ...
    retail: 13500,
    specs: [
      { label: "Sound", value: "JBL Pro Sound, racetrack driver" },
  ...
  },
  {
    ...
    name: "Xiaomi Smart Band 8 Fitness Band",
    brand: "Xiaomi",
    category: "Essentials",
    subcategory: "Wearable Fitness Bands",
    image: phone,
    retail: 3200,
    specs: [
      { label: "Display", value: '1.62" AMOLED' },
      { label: "Battery", value: "Up to 16 days" },
      { label: "Modes", value: "150+ sports modes, SpO2" },
    ],
  },
  {
    id: "google-nest-mini-2",
    name: "Google Nest Mini (2nd Gen) Smart Home Speaker",
    brand: "Google",
    category: "Essentials",
    ...
    retail: 4500,
    specs: [
      { label: "Assistant", value: "Google Assistant built-in" },
      { label: "Audio", value: "360° sound, 40mm driver" },
      { label: "Control", value: "Voice + touch controls" },
    ],
  },
  {
    id: "samsung-25w-adapter",
    name: "Samsung 25W Super Fast Wall Adapter (USB-C)",
    brand: "Samsung",
    category: "Accessories",
    subcategory: "Chargers & Cables",
    image: phone,
    retail: 2200,
    specs: [
      { label: "Power", value: "25W Super Fast Charging" },
      { label: "Port", value: "USB-C PD" },
      { label: "Compatibility", value: "Galaxy S-Series, Buds" },
    ],
  },
  {
    id: "anker-maggo-622",
    name: "Anker MagGo 622 Magnetic Power Bank 5000mAh",
    brand: "Anker",
    category: "Accessories",
    subcategory: "Power Banks",
    image: phone,
    ...
    specs: [
      ...
      { label: "Magnetic", value: "MagSafe-compatible 7.5W" },
      { label: "Design", value: "Foldable kickstand" },
    ],
  },
  {
    id: "baseus-blade-10000",
    name: "Baseus Blade Digital Display Power Bank 10000mAh 65W",
    brand: "Baseus",
    category: "Accessories",
    subcategory: "Power Banks",
    image: laptop,
    ...
    specs: [
      ...
      { label: "Output", value: "65W USB-C PD (laptop-ready)" },
      { label: "Thickness", value: "12.6mm ultra-slim" },
    ],
  },
  {
    id: "apple-smart-folio-ipad",
    name: "Apple Smart Folio for iPad Pro 11-inch",
    brand: "Apple",
    category: "Accessories",
    ...
    retail: 8500,
    specs: [
      { label: "Material", value: "Polyurethane microfiber" },
      { label: "Modes", value: "Front cover + multi-angle stand" },
      { label: "Compatibility", value: 'iPad Pro 11" (all generations)' },
    ],
  },
  {
    id: "spigen-iphone15-case",
    ...
    retail: 1800,
    specs: [
      { label: "Protection", value: "Hybrid PC + TPU, air cushion" },
      { label: "Feature", value: "MagSafe ring compatible" },
      { label: "Finish", value: "Anti-yellowing clear back" },
    ],
  },
  {
    ...
    specs: [
      ...
      { label: "Clicks", value: "Quiet Clicks, 90% less noise" },
      { label: "Battery", value: "70 days on full charge" },
    ],
  },
  {
    id: "apple-airtag",
    name: "Apple AirTag (Single)",
    brand: "Apple",
    category: "Essentials",
    image: camera,
    retail: 3900,
    specs: [
      { label: "Network", value: "Find My network (UWB)" },
      { label: "Battery", value: "1+ year replaceable CR2032" },
      { label: "Rating", value: "IP67 water & dust resistant" },
    ],
  },
  {
    id: "spigen-glas-tr-iphone15",
    name: "Spigen Glas.tR Tempered Glass Screen Protector (iPhone 15 Pro)",
    brand: "Spigen",
    category: "Essentials",
    image: phone,
    retail: 1200,
    specs: [
      ...
      { label: "Includes", value: "2 protectors + install frame" },
    ],
  },
...
export const listings: Listing[] = [
  ...
  // ── Accessories & Essentials (extended) listings ──
  {
    id: "l-50",
    productId: "belkin-boostcharge-30w",
    conditionScore: 95,
    listedAt: "2026-08-21",
    sellerNote:
      "Genuine Belkin 30W GaN charger, used for 3 months with iPhone 15. Compact travel-ready size.",
    inspection: [
      { component: "Charging output", status: "Full 30W PD verified" },
      { component: "Housing", status: "No cracks, prongs tight" },
      { component: "Heat", status: "Normal operating temps" },
    ],
    price: 2900,
    grade: "A",
    warrantyMonths: 0,
    ...
    physical: "Excellent",
    screen: "N/A",
    seller: { name: "Tanvir Rahman", verified: true, rating: 4.8, sales: 31, district: "Dhaka" },
  },
  {
    id: "l-51",
    productId: "baseus-usb4-cable-100w",
    conditionScore: 92,
    listedAt: "2026-08-20",
    sellerNote: "2m braided 100W cable in clean condition. No fraying, both ends grip firmly.",
    inspection: [
      { component: "Connectors", status: "Firm fit, no wobble" },
      { component: "Braid", status: "No fraying or exposed wire" },
      { component: "Charging", status: "100W pass-through verified" },
    ],
    price: 850,
    grade: "A",
    warrantyMonths: 0,
  ...
  {
    id: "l-52",
    productId: "samsung-25w-adapter",
    conditionScore: 96,
    listedAt: "2026-08-22",
    sellerNote: "Official Samsung 25W adapter. Barely used, comes with original box.",
    inspection: [
      { component: "Charging output", status: "Super fast charging verified" },
      { component: "Housing", status: "Like new" },
      { component: "Safety", status: "No overheating" },
    ],
    price: 1400,
    grade: "A+",
    warrantyMonths: 2,
    ...
    physical: "Like new",
    screen: "N/A",
    seller: { name: "Rumana Haque", verified: true, rating: 4.9, sales: 22, district: "Dhaka" },
  },
  {
    id: "l-53",
    productId: "anker-maggo-622",
    conditionScore: 90,
    listedAt: "2026-08-19",
    sellerNote:
      "Magnetic power bank with kickstand. Holds charge well, minor scuff on the stand hinge.",
    inspection: [
      { component: "Battery", status: "Full capacity, cycles within spec" },
      { component: "Magnets", status: "Strong snap alignment" },
      { component: "Hinge", status: "Kickstand works, light scuff" },
    ],
    price: 4200,
    grade: "A",
    warrantyMonths: 0,
    ...
    accessories: "Device only",
    repairs: "None",
    physical: "Good, minor scuff on hinge",
    screen: "N/A",
    seller: { name: "Imran Kabir", verified: true, rating: 4.8, sales: 17, district: "Dhaka" },
  },
  {
    id: "l-54",
    productId: "baseus-blade-10000",
    conditionScore: 93,
    listedAt: "2026-08-21",
    sellerNote: "Slim 65W power bank that charges my MacBook Air. Digital display works perfectly.",
    inspection: [
      { component: "Battery", status: "Healthy, full 10000mAh" },
      { component: "Display", status: "Digital percentage accurate" },
      { component: "Ports", status: "USB-C 65W + USB-A tested" },
    ],
    price: 2600,
    grade: "A",
    warrantyMonths: 0,
    invoice: false,
    accessories: "USB-C cable included",
    repairs: "None",
    physical: "Excellent",
    screen: "N/A",
    seller: { name: "Fahim Chowdhury", verified: true, rating: 4.9, sales: 12, district: "Khulna" },
  },
  {
    id: "l-55",
    productId: "apple-smart-folio-ipad",
    conditionScore: 88,
    listedAt: "2026-08-17",
    sellerNote:
      "Genuine Apple Smart Folio for 11-inch iPad Pro. Light wear on the outer fabric, interior clean.",
    inspection: [
      { component: "Exterior", status: "Light fabric wear, no stains" },
      { component: "Interior", status: "Clean microfiber, no scratches" },
      { component: "Magnets", status: "Auto wake/sleep working" },
    ],
    price: 4900,
    grade: "B",
    warrantyMonths: 0,
    ...
    accessories: "Device only",
    repairs: "None",
    physical: "Good, visible light wear",
    screen: "N/A",
    seller: { name: "Shakil Hasan", verified: true, rating: 4.9, sales: 26, district: "Sylhet" },
  },
  {
    id: "l-56",
    productId: "spigen-iphone15-case",
    conditionScore: 94,
    listedAt: "2026-08-23",
    sellerNote: "Used for 2 months, no yellowing. Switched to a leather case so selling this one.",
    inspection: [
      { component: "Clarity", status: "No yellowing, crystal clear" },
      { component: "Buttons", status: "Tactile, aligned" },
      { component: "MagSafe ring", status: "Aligns and holds" },
    ],
    price: 950,
    grade: "A+",
    warrantyMonths: 0,
    ...
    physical: "Like new",
    screen: "N/A",
    seller: { name: "Nusrat Jahan", verified: true, rating: 5.0, sales: 8, district: "Chattogram" },
  },
  {
    id: "l-57",
    ...
    listedAt: "2026-08-16",
    sellerNote:
      "Best productivity mouse, used daily at a desk setup. All buttons and scroll wheel tested.",
    inspection: [
      { component: "Sensor", status: "Tracking accurate across surfaces" },
      { component: "Scroll", status: "MagSpeed wheel smooth, ratchet mode works" },
      { component: "Battery", status: "Holds full charge, weeks of use" },
      { component: "Receiver", status: "Bolt USB receiver included" },
    ],
    price: 7800,
    grade: "A",
    warrantyMonths: 1,
    invoice: true,
    accessories: "Bolt receiver, charging cable",
    repairs: "None",
    physical: "Very good, light palm shine",
    screen: "N/A",
    seller: { name: "Rafiq H.", verified: true, rating: 4.9, sales: 23, district: "Dhaka" },
  },
  {
    ...
    conditionScore: 97,
    listedAt: "2026-08-22",
    sellerNote: "Single AirTag with fresh CR2032 battery. Used on keys, no scratches.",
    inspection: [
      { component: "Find My", status: "Connects instantly, precision finding works" },
      { component: "Speaker", status: "Chime loud and clear" },
      { component: "Battery", status: "New CR2032 installed" },
    ],
    price: 2700,
    grade: "A+",
    warrantyMonths: 0,
  ...
  {
    id: "l-59",
    productId: "spigen-glas-tr-iphone15",
    conditionScore: 96,
    listedAt: "2026-08-23",
    sellerNote:
      "Bought a 2-pack, using only one. Sealed second piece with the installation frame included.",
    inspection: [
      { component: "Glass", status: "Sealed, no cracks or chips" },
      { component: "Oleophobic layer", status: "Intact, smudge resistant" },
      { component: "Cutouts", status: "Perfect alignment for sensors" },
    ],
    price: 550,
    grade: "A+",
    warrantyMonths: 0,
    invoice: false,
    accessories: "Sealed pack with install frame",
    repairs: "None",
    physical: "Like new (sealed)",
    screen: "N/A",
    seller: { name: "Nusrat Jahan", verified: true, rating: 5.0, sales: 8, district: "Chattogram" },
  },
  {
    id: "l-60",
    productId: "baseus-cable-organizer",
    conditionScore: 93,
    listedAt: "2026-08-20",
    sellerNote: "Travel pouch used on two trips. Zips smooth, no tears, elastic loops hold firm.",
    inspection: [
      { component: "Zippers", status: "Smooth, both tracks intact" },
      { component: "Fabric", status: "No tears, water-repellent finish working" },
      { component: "Loops", status: "All 3 elastic loops firm" },
    ],
    price: 450,
    grade: "A",
    warrantyMonths: 0,
  ...
  {
    id: "l-61",
    productId: "samsung-galaxy-buds2",
    conditionScore: 92,
    listedAt: "2026-08-21",
    sellerNote: "Galaxy Buds2 with ANC. Ear tips sanitized, case has a small scratch on the lid.",
    inspection: [
      { component: "ANC", status: "Active noise cancellation working" },
      { component: "Battery", status: "Buds 90%+, case charges fine" },
      { component: "Bluetooth", status: "Pairs instantly, both buds sync" },
    ],
    price: 5800,
    grade: "A",
    warrantyMonths: 0,
    invoice: false,
    accessories: "Charging case, 2 extra tip sizes",
    repairs: "None",
    physical: "Very good, light scratch on case lid",
    screen: "N/A",
    seller: { name: "Imran Kabir", verified: true, rating: 4.8, sales: 17, district: "Dhaka" },
  },
  {
    id: "l-62",
    productId: "jbl-flip-6",
    conditionScore: 89,
    listedAt: "2026-08-18",
    sellerNote:
      "Loud, clean JBL sound. Rubber shell has minor scuffs from outdoor use, sounds flawless.",
    inspection: [
      { component: "Sound", status: "No distortion at max volume" },
      { component: "Battery", status: "Full 12h playtime tested" },
      { component: "Water seal", status: "IP67 flap intact, passive radiator firm" },
    ],
    price: 8900,
    grade: "A",
    warrantyMonths: 0,
    ...
    accessories: "USB-C cable",
    repairs: "None",
    physical: "Good, minor shell scuffs",
    screen: "N/A",
    seller: { name: "Fahim Chowdhury", verified: true, rating: 4.9, sales: 12, district: "Khulna" },
  },
  {
    ...
    listedAt: "2026-08-23",
    sellerNote:
      "Smart Band 8 with metal strap. Screen has a protector on since day one, no scratches underneath.",
    inspection: [
      { component: "Display", status: "AMOLED bright, no dead pixels" },
      { component: "Sensors", status: "Heart rate & SpO2 readings accurate" },
      { component: "Battery", status: "14+ days per charge verified" },
    ],
    price: 2300,
    grade: "A+",
    warrantyMonths: 0,
    invoice: false,
    accessories: "Metal strap + original silicone strap",
    repairs: "None",
    physical: "Like new",
    screen: "Flawless with protector",
    seller: { name: "Rumana Haque", verified: true, rating: 4.9, sales: 22, district: "Dhaka" },
  ...
  {
    id: "l-64",
    productId: "google-nest-mini-2",
    conditionScore: 91,
    listedAt: "2026-08-19",
    sellerNote:
      "Nest Mini in chalk color. Voice assistant and touch controls all working, fabric clean.",
    inspection: [
      { component: "Assistant", status: "Voice match and responses working" },
      { component: "Speaker", status: "360 sound clear, bass OK" },
      { component: "Wall mount", status: "Slot intact" },
    ],
    price: 2900,
    grade: "A",
    warrantyMonths: 0,
