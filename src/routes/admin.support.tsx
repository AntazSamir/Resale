...
export const Route = createFileRoute("/admin/support")({
  head: () => ({
    meta: [{ title: "Support Tickets | Admin Console | Resale.com" }],
  }),
          ...
          <Card className="border-dashed border-2 bg-muted/30">
            <CardHeader className="text-center pb-2">
              ...
              <CardDescription className="max-w-md mx-auto mt-2">
                The backend infrastructure for the <strong>Support Tickets</strong> module does not
                yet exist in the current marketplace architecture.
              </CardDescription>
            </CardHeader>
