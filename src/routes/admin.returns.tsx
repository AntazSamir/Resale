...
import { CornerUpLeft, Clock, AlertCircle } from "lucide-react";

export const Route = createFileRoute("/admin/returns")({
  head: () => ({
    meta: [{ title: "Returns & Refunds | Admin Console | Resale.com" }],
  }),
        ...
        <div className="space-y-6 max-w-4xl">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold font-display tracking-tight text-foreground flex items-center gap-2">
              <CornerUpLeft className="size-8 text-primary" />
              Returns & Refunds
            </h1>
          ...
          <Card className="border-dashed border-2 bg-muted/30">
            <CardHeader className="text-center pb-2">
              ...
              <CardDescription className="max-w-md mx-auto mt-2">
                The backend infrastructure for the <strong>Returns & Refunds</strong> module does
