              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={category} onValueChange={setCategory}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Accessories & Chargers">Accessories & Chargers</SelectItem>
                ...
                <div className="space-y-2">
                  ...
                  {step1Touched && !accessories && (
                    <p className="text-xs text-destructive">Please select accessories included.</p>
                  )}
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-4">
                <div className="bg-muted/50 p-6 rounded-md space-y-4">
                  ...
                  <div className="flex flex-wrap gap-3 text-sm text-muted-foreground border-t border-border pt-3">
                    ...
                    <span>·</span>
                    <span className="font-medium text-foreground">{taka(Number(price) || 0)}</span>
                  </div>
