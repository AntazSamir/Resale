...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Resale — Buy & Sell Verified Used Electronics in Bangladesh" },
      {
        name: "description",
        content:
          "Bangladesh's trusted marketplace for graded pre-owned electronics. Every listing is condition-scored, seller-verified, and delivered with cash on delivery.",
      },
      {
        property: "og:title",
        content: "Resale — Buy & Sell Verified Used Electronics in Bangladesh",
      },
      {
        property: "og:description",
        content:
          "Buy and sell smartphones, laptops, and accessories with full condition transparency.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Archivo:wght@400;500;600;700&family=Inter+Tight:wght@400;500;600&display=swap",
      },
    ],
  }),
    ...
    <QueryClientProvider client={queryClient}>
      <AuthProvider>
        <CartProvider>
          ...
          <div
            key={pathname}
            className="animate-page-enter flex flex-col flex-1 w-full min-h-screen"
          >
