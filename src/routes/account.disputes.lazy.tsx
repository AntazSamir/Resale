...
export const Route = createLazyFileRoute("/account/disputes")({
...
export function DisputesPage() {
  ...
  return (
    <ProtectedRoute redirect="/account/disputes">
      <div className="min-h-screen bg-background flex flex-col">
        <SiteHeader />
                              ...
                              <>
                                ...
                                <div>
                                  ...
                                  <span>
                                    ...
                                    <strong>{eligibility.minutesRemaining} minutes</strong>{" "}
                                    remaining to submit this claim.
                                  </span>
                                </div>
                              </>
                            ) : (
                ...
                <Card className="border-border">
                  ...
                  <CardContent className="text-xs space-y-3 text-subtle-foreground leading-relaxed">
                    ...
                    <div>
                      ...
                      <span>
                        The seller can accept return immediately or upload packaging proof/IMEI
                        match.
                      </span>
                    </div>
                    <div>
              ...
              {myDisputes.length === 0 ? (
                <div className="text-center py-16 border border-dashed border-border bg-card p-6">
                  ...
                  <p className="text-xs text-muted-foreground mt-1 max-w-sm mx-auto">
                    ...
                    active 48h guarantee can be disputed from the &ldquo;File New Dispute&rdquo;
                    tab.
                  </p>
                          ...
                          {d.adminVerdict && (
                            <div className="p-3 bg-emerald-500/10 border border-emerald-500/20 text-xs space-y-1">
                              <span className="font-bold text-emerald-700 dark:text-emerald-300 block">
                                ✓ Resolution: {d.adminVerdict.decision.replace(/_/g, " ")}{" "}
                                (Simulated)
                              </span>
